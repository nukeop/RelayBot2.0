class Plugin(object):
    ...
    @property
    def long_desc(self):
    """Long description of this plugin's functionality - should be exhaustive
    and describe all nuances of using it. This will be shown to users who
    request help about this particular plugin, which means it should be as long
    as needed.
    """
    raise NotImplementedError("Plugin should never be created directly")
